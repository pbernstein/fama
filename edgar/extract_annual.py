...
for record in f:
	...
	local_fn = path+"/"+name+"_10k_"+year+"q"+quarter+".dat" 
	loaded_fn = loaded_path+"/"+name+"_10k_"+year+"q"+quarter+".dat"
	not_xbrl_fn = not_xbrl_path+"/"+name+"_10k_"+year+"q"+quarter+".dat"
	error_fn = error_path+"/"+name+"_10k_"+year+"q"+quarter+".dat"
	error_canada_fn = error_canada_path+"/"+name+"_10k_"+year+"q"+quarter+".dat"
	...
	if  form == "10-K":
		...
		if os.path.isfile(local_fn) == False:
			...
			call(["wget", "-O", local_fn, "ftp://ftp.sec.gov/"+sec_fn])
			print "wget","-q", "-O", local_fn, "ftp://ftp.sec.gov/"+sec_fn
		else:
